...
#define LOG_TIME_MS				100
#define LED_TIME_MS				500

// Complementary Filter
#define COMP_FILTER_ALPHA	0.1f
#define SAMPLE_TIME_MS		1.0f							// 1kHz ODR from MPU6050
#define LPF_GYR_ALPHA			0.1f
#define LPF_ACC_ALPHA			0.5f
...
UART_API uart;
MPU6050 imu;
CompFilterRollPitch comp_filter;

HAL_StatusTypeDef status;
uint32_t timer_log = 0;
